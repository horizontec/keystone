 ...
 * @api public
 */
function customRelationship (list, path, options) {
	...
	customRelationship.super_.call(this, list, path, options);
}
customRelationship.properName = 'CustomRelationship';
util.inherits(customRelationship, FieldType);

/**
 * Get client-side properties to pass to react field.
 */
customRelationship.prototype.getProperties = function () {
...
customRelationship.prototype.getExpandedData = function (item) {
 ...
 */
customRelationship.prototype.addToSchema = function (schema) {
	var field = this;
	var def = {
 ...
 */
customRelationship.prototype.getData = function (item) {
	var value = item.get(this.path);
	if (this.many) {
 ...
 */
customRelationship.prototype.addFilterToQuery = function (filter) {
	var query = {};
 ...
 */
customRelationship.prototype.format = function (item) {
	var value = item.get(this.path);
 ...
 */
customRelationship.prototype.validateInput = function (data, callback) {
 ...
 */
customRelationship.prototype.validateRequiredInput = function (item, data, callback) {
	var value = this.getValueFromData(data);
	var result = false;
	if (value === undefined) {
		if (this.many) {
 ...
 * Deprecated
 */
customRelationship.prototype.inputIsValid = function (data, required, item) {
 ...
 */
customRelationship.prototype.updateItem = function (item, data, callback) {
...
definePrototypeGetters(customRelationship, {
...
/* Export Field Type */
module.exports = customRelationship;
